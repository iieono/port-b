...
export default function Home() {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div className="percent-container fixed bg-black w-full h-full z-50 flex items-end justify-end text-custom-red font-bold sharpie-text text-4xl lg:text-[10rem] active">
