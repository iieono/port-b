...
export default function Home() {
  return (
    <div className=" h-full w-full flex items-center lg:items-start justify-start gap-5 lg:justify-between  flex-col p-2 py-5 pt-24 lg:p-5 lg:px-20">
      <div className="leading-none sharpie-text text-[4rem] w-full px-5 lg:text-[14rem] flex items-start justify-start flex-col ">
        <p className="">
          DESIGNER <span className="text-primary">&</span>
        </p>
        <p>DEVELOPER</p>
      </div>
      <div className="w-full h-full flex flex-col items-start lg:items-end text-xl lg:text-3xl px-5 text-primary technor-text font-light justify-end">
        <p>
      ...
      <div className="flex self-end w-full h-full items-end uppercase justify-center">
        <div className="flex gap-10 items-end justify-start px-20 raleway text-3xl  h-full w-full">
          <div>github</div>
          <div>email</div>
        </div>
        <div className="absolute bg-primary text-4xl lg:text-8xl bottom-0 right-0 px-8 py-4 gap-3 lg:gap-6 flex items-center rounded-tl-[50px]">
          ...
          <div className="aspect-square h-full absolute right-0 -translate-y-full bg-primary top-0">
            <div className="w-full h-full bg-custom-red rounded-br-[30px]"></div>
          </div>
